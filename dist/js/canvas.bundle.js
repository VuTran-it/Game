...
canvas.width = 1024;
canvas.height = 576;
var gravity = 1.5; // tạo ra trọng lực cho game

var Player = /*#__PURE__*/function () {
  function Player() {
    _classCallCheck(this, Player);

    this.speed = 10; //vị trí nhân vật
  ...
  _createClass(Player, [{
    key: "draw",
    value: function draw() {
      c.drawImage(this.currentSprite, this.currentCropWidth * this.frames, // cắt hình từ đầu
    ...
    value: function update() {
      ...
      this.position.y += this.velocity.y; //tạo ra trọng lực
...
var srcollOffset = 0; //Đoạn đường nhân vật đi được
...
function restart() {
  ...
  platforms = [new Platform({
    ...
    x: platformImage.width * 7 + 700 - 3 + platformImage.width - platformSmallTallImage.width,
    y: 200,
    image: platformSmallTallImage
  }), new Platform({
    x: platformImage.width * 8 + 700 - 3 + platformImage.width - platformSmallTallImage.width,
    y: 150,
    image: platformSmallTallImage
  }), new Platform({
    x: platformImage.width * 9 + 700 - 3 + platformImage.width - platformSmallTallImage.width,
    y: 200,
    image: platformSmallTallImage
  }), new Platform({
    x: platformImage.width * 10 + 900 - 3,
    y: 470,
    image: platformImage
  })];
